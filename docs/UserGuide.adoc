...
image::service pre clear.PNG[width="419"]

The command box aft kbd:[Alt] is pressed:

image::service post clear.PNG[width="371"]
...
image::add PREFIX_NAME.PNG[width="581"]
