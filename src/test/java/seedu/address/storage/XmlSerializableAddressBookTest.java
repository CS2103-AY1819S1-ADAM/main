...
public class XmlSerializableAddressBookTest {
    ...
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidGuestAddressBook.xml");
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicateGuestAddressBook.xml");
