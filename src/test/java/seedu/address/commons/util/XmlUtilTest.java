...
public class XmlUtilTest {
    ...
    private static final Path MISSING_GUEST_FIELD_FILE = TEST_DATA_FOLDER.resolve("missingPersonField.xml");
    private static final Path INVALID_GUEST_FIELD_FILE = TEST_DATA_FOLDER.resolve("invalidPersonField.xml");
    private static final Path VALID_GUEST_FILE = TEST_DATA_FOLDER.resolve("validPerson.xml");
