...
public class CommandParameterSyntaxHandlerTest {
    ...
    @Test
    public void getMissingPrefix_reassignCommand_allPrefixesMissing() {
        ArrayList<Prefix> result = handler.getMissingPrefixes(ReassignCommand.COMMAND_WORD,
            ReassignCommand.COMMAND_WORD);
        assertEquals(result, handler.REASSIGN_COMMAND_PREFIXES);
    }
