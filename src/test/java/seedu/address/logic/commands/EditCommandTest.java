...
public class EditCommandTest {
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Guest guestInList = model.getConcierge().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON,
    ...
    public void execute_invalidPersonIndexFilteredList_failure() {
        ...
        assertTrue(outOfBoundIndex.getZeroBased() < model.getConcierge().getPersonList().size());
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        // undo -> reverts concierge back to previous state and filtered guest list to show all persons
