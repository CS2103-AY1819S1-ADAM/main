...
import static seedu.address.testutil.TypicalGuests.getTypicalPersons;
...
public class GuestListPanelTest extends GuiUnitTest {
    ...
    /**
     * Verifies that creating and deleting large number of persons in {@code GuestListPanel} requires lesser than
