...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyGuestList> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyGuestList> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableGuestList(this.initialDataSupplier.get()),
    ...
    public Model getModel() {
        ...
        ModelHelper.setFilteredList(copy, model.getFilteredGuestList());
        return copy;
    }
