...
public class EditCommandSystemTest extends GuestListSystemTest {
    ...
    public void edit() {
        ...
        assertTrue(getModel().getGuestList().getListOfGuests().contains(BOB));
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_GUEST.getOneBased() + INVALID_ADDRESS_DESC,
        ...
        executeCommand(GuestUtil.getAddCommand(BOB));
        assertTrue(getModel().getGuestList().getListOfGuests().contains(BOB));
        index = INDEX_FIRST_GUEST;
