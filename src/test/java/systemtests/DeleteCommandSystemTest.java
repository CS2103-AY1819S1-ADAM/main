...
public class DeleteCommandSystemTest extends ConciergeSystemTest {
    ...
    public void delete() {
        ...
        Guest deletedGuest = removePerson(expectedModel, INDEX_FIRST_PERSON);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedGuest);
        ...
        /* Case: filtered guest list, delete index within bounds of concierge and guest list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_PERSON;
        assertTrue(index.getZeroBased() < getModel().getFilteredPersonList().size());
        assertCommandSuccess(index);

        /* Case: filtered guest list, delete index within bounds of concierge but out of bounds of guest list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        int invalidIndex = getModel().getConcierge().getPersonList().size();
        ...
        expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedGuest);
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getConcierge().getPersonList().size() + 1);
    ...
    /**
     * Removes the {@code Guest} at the specified {@code index} in {@code model}'s concierge.
     ...
     * {@code ConciergeSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
