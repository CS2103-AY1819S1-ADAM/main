...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @Subscribe
    public void handleConciergeChangedEvent(ConciergeChangedEvent cce) {
        long now = clock.millis();
        String lastUpdated = new Date(now).toString();
        logger.info(LogsCenter.getEventHandlingLogMessage(cce, "Setting last updated status to " + lastUpdated));
